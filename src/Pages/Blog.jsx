...
//             Discover the latest trends, expert tips, and insights from the world of men's grooming and style.
//           </p>
//         </motion.div>
...
//           {/* Loading Skeletons */}
//           {loading && page === 1 && [...Array(6)].map((_, i) => (
...
const BlogPreview = ({ posts }) => {
  return (
    <section className="relative py-20 bg-gray-50 overflow-hidden">
      ...
      <motion.div
        className="absolute top-0 left-0 w-96 h-96 bg-amber-400/5 rounded-full blur-3xl -ml-48 -mt-48"
        animate={{ y: [0, -20, 0], x: [0, 15, 0] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-0 right-0 w-96 h-96 bg-purple-400/5 rounded-full blur-3xl -mr-48 -mb-48"
        animate={{ y: [0, 20, 0], x: [0, -15, 0] }}
      ...
      <div className="container relative mx-auto px-6">
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-bold cinzel text-gray-900 mb-4"
        >
          Latest Articles & News
        </motion.h1>
        ...
        >
          Stay updated with industry insights and expert opinions
        </motion.p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h2 className="text-xl font-semibold mb-2 text-gray-800 group-hover:text-amber-600 transition-colors">
                  {post.title}
                </h2>
        ...
        <motion.div
          ...
          className="text-center mt-12"
        >
          <button className="px-6 py-3 bg-amber-600 text-white rounded-full shadow-lg hover:bg-amber-700 transition-colors">
            Load More
          </button>
        </motion.div>
      </div>
