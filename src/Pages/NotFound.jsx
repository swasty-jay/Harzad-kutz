...
//   return (
//     <div className="min-h-60 bg-gray-50 py-30 sm:py-33 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
...
//           >
//             <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-9xl font-bold text-[#1A1A1A] tracking-tight font-[poppins]">
...
//         >
//           <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-bold text-[#1A1A1A] mb-2 sm:mb-4 font-[poppins] italic">
